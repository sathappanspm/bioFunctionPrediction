...
OUTDIR="/home/sathap1/workspace/bioFunctionPrediction/results_multiCNN"
mkdir -p $OUTDIR

python ./multicharcnn_run.py --function bp --data ./resources --outputdir $OUTDIR --trainsize 2000 --testsize 2000 --validationsize 100
source deactivate
