...
#PBS -e /home/sathap1/workspace/bioFunctionPrediction/results/multiCNN/error_mf.log
#PBS -o /home/sathap1/workspace/bioFunctionPrediction/results/multiCNN/output_mf.log

OUTDIR="/home/sathap1/workspace/bioFunctionPrediction/results/multiCNN/models/mf"
...
python ${SCRIPT_ROOT}/multicharcnn_run.py --function mf --resources ${SCRIPT_ROOT}/../resources --outputdir $OUTDIR --trainsize 6000 --testsize 6000 --validationsize 100 --inputfile ${SCRIPT_ROOT}/../AllSeqsWithGO_expanded.tar --batchsize 32 --pretrained ${SCRIPT_ROOT}/../resources/protVec_100d_3grams.csv
