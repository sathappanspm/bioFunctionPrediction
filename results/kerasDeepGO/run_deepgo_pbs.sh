...
#PBS -e /home/sathap1/workspace/bioFunctionPrediction/results/kerasDeepGO/error_pretrained.log
#PBS -o /home/sathap1/workspace/bioFunctionPrediction/results/kerasDeepGO/output_pretrained.log

OUTDIR="/home/sathap1/workspace/bioFunctionPrediction/results/kerasDeepGO/pretrained/"
...
python ${SCRIPT_ROOT}/keras_deepgorun.py --function bp --resources ${SCRIPT_ROOT}/../resources --outputdir $OUTDIR --trainsize 2000 --testsize 2000 --validationsize 100 --inputfile ${SCRIPT_ROOT}/../AllSeqsWithGO_expanded.tar --batchsize 128 --pretrained ${SCRIPT_ROOT}/../resources/protVec_100d_3grams.csv
