...
RESULTDIR="${HOME}/${LOCAL}/bioFunctionPrediction/results/rnnpred/"
...
BATCHSIZE=64
python ./rnnEmbedding.py --function '' --resources ${SCRIPT_ROOT}/../resources --inputfile ${DATA} --batchsize $BATCHSIZE --featuretype ngrams --maxseqlen 2002  --outputdir $OUTDIR --trainsize $(( 18815 / $BATCHSIZE )) --testsize $(( 5846 / $BATCHSIZE )) --validationsize $(( 4704 / $BATCHSIZE )) --num_epochs 20
