...
#PBS -e /home/sathap1/workspace/bioFunctionPrediction/results/danq/error.log
#PBS -o /home/sathap1/workspace/bioFunctionPrediction/results/danq/output.log

OUTDIR="/home/sathap1/workspace/bioFunctionPrediction/results/danq/"
...
python ${SCRIPT_ROOT}/keras_danq_run.py --function bp --resources ${SCRIPT_ROOT}/../resources --outputdir $OUTDIR --trainsize 2000 --testsize 2000 --validationsize 100 --inputfile ${SCRIPT_ROOT}/../AllSeqsWithGO_expanded.tar --batchsize 32
