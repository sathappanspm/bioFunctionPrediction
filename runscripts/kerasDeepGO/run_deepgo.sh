...
##PBS -e /home/sathap1/workspace/bioFunctionPrediction/results/kerasDeepGO/error.log
##PBS -o /home/sathap1/workspace/bioFunctionPrediction/results/kerasDeepGO/output.log

OUTDIR="/home/sathap1/workspace/bioFunctionPrediction/results/kerasDeepGO/"
...
python ${SCRIPT_ROOT}/keras_deepgorun.py --function bp --data ${SCRIPT_ROOT}/../resources --outputdir $OUTDIR --trainsize 20 --testsize 20 --validationsize 100
